...
document.getElementById("CheckBox").addEventListener("click", () => {
    ...
    alert(userNamecookie, passwordcookie)
    document.cookie = "myCookieUserName" + "=" + userNamecookie;
    document.cookie = "myPasswordCookie" + "=" + passwordcookie;
    alert(getCookie(userNamecookie))
  });
